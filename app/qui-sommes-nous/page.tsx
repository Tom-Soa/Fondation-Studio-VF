              ...
              <div className="rounded-3xl border border-grid-line bg-alabaster overflow-hidden h-full">
                ...
                <div className="p-7">
                  ...
                  <div className="flex items-center gap-3">
                    <a href="https://www.instagram.com/fondation.studio" target="_blank" rel="noopener noreferrer" className="grid h-9 w-9 place-items-center rounded-full border border-grid-line bg-white text-steel hover:text-midnight hover:border-midnight/30 transition-colors" aria-label="Instagram Tom-Soa">
                    ...
                    <a href="https://www.linkedin.com/in/tom-soa-cyprien" target="_blank" rel="noopener noreferrer" className="grid h-9 w-9 place-items-center rounded-full border border-grid-line bg-white text-steel hover:text-[#0A66C2] hover:border-[#0A66C2]/30 transition-colors" aria-label="LinkedIn Tom-Soa">
