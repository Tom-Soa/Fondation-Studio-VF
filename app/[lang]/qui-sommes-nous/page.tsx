...
const T: Record<Locale, {
  ...
  valeurs: { num: string; title: string; body: string }[];
  schemaTomJobTitle: string;
  schemaTomDescription: string;
  schemaAndyJobTitle: string;
  schemaAndyDescription: string;
  ...
  fr: {
    metaTitle: "L'équipe",
    metaDescription:
      "Tom-Soa Cyprien et Andylane Chatenay, entrepreneurs et fondateurs de ACTC. On comprend les problématiques des entreprises de l'intérieur et on accompagne pour trouver des clients et se développer.",
    ogTitle: "L'équipe · ACTC",
    ogDescription:
      "Tom-Soa Cyprien et Andylane Chatenay, entrepreneurs et fondateurs de ACTC.",
    valeurs: [
      {
        num: "01",
    ...
    schemaTomJobTitle: "Co-fondateur de ACTC",
    schemaTomDescription:
      "Entrepreneur, Tom-Soa Cyprien pilote la direction artistique, le parcours client et les stratégies d'acquisition payante (Meta, Google) chez ACTC. Il conçoit des sites qui convertissent et des campagnes qui ramènent des clients.",
    schemaAndyJobTitle: "Co-fondateur de ACTC",
    schemaAndyDescription:
      "Entrepreneur expérimenté, Andylane Chatenay maîtrise le référencement naturel, l'optimisation des textes pour vendre et la stratégie commerciale chez ACTC. Il aide les entrepreneurs à réduire leurs coûts et à trouver de meilleures solutions opérationnelles.",
    breadcrumbHome: "Accueil",
    breadcrumbTeam: "L'équipe",
    kicker: "L'équipe",
    h1Start: "Deux entrepreneurs.",
    h1Accent: "Un seul objectif.",
    heroIntro:
    ...
    tomAlt: "Tom-Soa Cyprien, co-fondateur ACTC",
    tomRoles: "Design · Publicité payante · Parcours client",
    tomBio:
    ...
    tomSkills: ["Design web", "Publicité Meta & Google", "Parcours client", "Direction artistique"],
    andyAlt: "Andylane Chatenay, co-fondateur ACTC",
    andyRoles: "SEO · Optimisation textuelle · Stratégie commerciale",
    andyBio:
    ...
    andySkills: ["SEO & référencement", "Optimisation textuelle", "Stratégie commerciale", "Développement web"],
    quoteKicker: "Au-delà du site",
    quote:
    ...
    quoteAuthor: "Tom-Soa & Andylane, fondateurs",
    valuesKicker: "Ce qui nous guide",
    valuesTitle: "Nos valeurs, en vrai.",
    ctaBadge: "Réponse rapide · Sans engagement",
    ctaH2Start: "On travaille",
    ctaH2Accent: "ensemble ?",
    ctaBody:
      "Parlez-nous de votre projet et de vos objectifs. On vous répond rapidement pour voir si on est la bonne équipe pour vous.",
  ...
  en: {
    metaTitle: "The team",
    metaDescription:
      "Tom-Soa Cyprien and Andylane Chatenay, entrepreneurs and founders of ACTC. We understand business challenges from the inside and help you win clients and grow.",
    ogTitle: "The team · ACTC",
    ogDescription:
      "Tom-Soa Cyprien and Andylane Chatenay, entrepreneurs and founders of ACTC.",
    valeurs: [
      {
        num: "01",
        title: "Total transparency",
        body: "We will never sell you something you don't need. On the call, we tell you the truth about what will work for your business, even if it means we are not the right fit.",
      },
      {
        num: "02",
        title: "Results first",
        body: "We don't build websites to look pretty. We build them to bring in clients. Every section, every button, every word is designed to convert your visitors.",
      },
      {
        num: "03",
        title: "Zero lock-in",
        body: "Your website is 100% yours. No subscription, no technical lock-in. If you leave tomorrow, you take everything with you. That's how we prove we deserve your trust.",
      },
    ],
    schemaTomJobTitle: "Co-founder of ACTC",
    schemaTomDescription:
      "An entrepreneur, Tom-Soa Cyprien leads art direction, customer journeys and paid acquisition strategies (Meta, Google) at ACTC. He designs websites that convert and campaigns that bring in clients.",
    schemaAndyJobTitle: "Co-founder of ACTC",
    schemaAndyDescription:
      "A seasoned entrepreneur, Andylane Chatenay masters SEO, sales-driven copy optimization and business strategy at ACTC. He helps business owners cut costs and find better operational solutions.",
    breadcrumbHome: "Home",
    breadcrumbTeam: "The team",
    kicker: "The team",
    h1Start: "Two entrepreneurs.",
    h1Accent: "One single goal.",
    heroIntro:
      "Before being website makers, we are entrepreneurs. We understand your challenges from the inside: winning clients, getting known, taking your business online. That's why our websites actually work.",
    cofounder: "Co-founder",
    tomAlt: "Tom-Soa Cyprien, co-founder of ACTC",
    tomRoles: "Design · Paid advertising · Customer journey",
    tomBio:
      "An entrepreneur for several years, Tom-Soa leads art direction, customer journeys and paid acquisition strategies (Meta, Google). He designs websites that convert and campaigns that bring in clients.",
    tomSkills: ["Web design", "Meta & Google ads", "Customer journey", "Art direction"],
    andyAlt: "Andylane Chatenay, co-founder of ACTC",
    andyRoles: "SEO · Copy optimization · Business strategy",
    andyBio:
      "A seasoned entrepreneur, Andylane masters SEO, sales-driven copy optimization and business strategy. He also helps business owners cut costs and find better operational solutions.",
    andySkills: ["SEO & rankings", "Copy optimization", "Business strategy", "Web development"],
    quoteKicker: "Beyond the website",
    quote:
      "\"We are not just website makers. We are entrepreneurs who understand your challenges from the inside: winning clients, cutting costs, taking your business online, building your presence. We can support you beyond the website: acquisition strategy, advice on your priorities, and setting up your complete digital ecosystem.\"",
    quoteAuthor: "Tom-Soa & Andylane, founders",
    valuesKicker: "What drives us",
    valuesTitle: "Our values, for real.",
    ctaBadge: "Fast response · No commitment",
    ctaH2Start: "Shall we work",
    ctaH2Accent: "together?",
    ctaBody:
      "Tell us about your project and your goals. We reply quickly so you can see if we are the right team for you.",
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    ...
    alternates: { canonical: localeHref(locale, "/qui-sommes-nous") },
    openGraph: {
      title: t.ogTitle,
    ...
    <main>
      <JsonLd
        schema={[
          personSchema({
            ...
            jobTitle: t.schemaTomJobTitle,
            description: t.schemaTomDescription,
          ...
          personSchema({
            ...
            jobTitle: t.schemaAndyJobTitle,
            description: t.schemaAndyDescription,
            image: "/images/andy-lan.png",
          }),
          breadcrumbSchema([
            { name: t.breadcrumbHome, path: localeHref(lang, "/") },
            { name: t.breadcrumbTeam, path: localeHref(lang, "/qui-sommes-nous") },
          ]),
        ]}
      />
      {/* Hero */}
      <section className="relative isolate overflow-hidden bg-alabaster pt-32 pb-16 lg:pt-44 lg:pb-20">
        ...
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="text-[11px] uppercase tracking-[0.18em] text-terra font-medium mb-5">{t.kicker}</div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Reveal>
              <div className="rounded-3xl border border-grid-line bg-alabaster overflow-hidden h-full">
                <div className="aspect-[4/3] overflow-hidden">
                  <img src="/images/tom-soa.jpg" alt={t.tomAlt} className="w-full h-full object-cover object-top" />
                </div>
                <div className="p-7">
                  ...
                  <p className="text-[13px] text-steel font-medium mt-1 mb-4">{t.tomRoles}</p>
            ...
            <Reveal delay={0.1}>
              <div className="rounded-3xl border border-grid-line bg-alabaster overflow-hidden h-full">
                <div className="aspect-[4/3] overflow-hidden">
                  <img src="/images/andy-lan.png" alt={t.andyAlt} className="w-full h-full object-cover object-top" />
                </div>
                <div className="p-7">
                  <div className="inline-flex items-center gap-2 rounded-full bg-terra/10 px-3 py-1 text-[11px] font-semibold text-terra mb-4">
                    {t.cofounder}
                  ...
                  <p className="text-[13px] text-steel font-medium mt-1 mb-4">{t.andyRoles}</p>
                  <p className="text-[14px] leading-relaxed text-steel mb-5">
                    {t.andyBio}
                  </p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <Reveal>
            <div className="rounded-3xl border border-grid-line bg-white p-10 lg:p-14">
              <div className="text-[11px] uppercase tracking-[0.18em] text-terra font-medium mb-8">{t.quoteKicker}</div>
              ...
              <div className="mt-8 flex items-center gap-3">
                ...
                <span className="text-[13px] font-medium text-steel">{t.quoteAuthor}</span>
              </div>
            </div>
          </Reveal>
        </div>
      ...
      <section className="bg-white py-20 lg:py-24 border-t border-grid-line">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            <div className="text-[11px] uppercase tracking-[0.18em] text-terra font-medium mb-3">{t.valuesKicker}</div>
            ...
            <div className="relative overflow-hidden rounded-[2rem] bg-terra px-6 py-14 sm:px-10 sm:py-16 lg:px-16 lg:py-20 text-center">
              ...
              <div className="relative">
                ...
                <h2 className="mt-6 font-display font-extrabold tracking-[-0.03em] leading-[1.04] text-white text-[clamp(2rem,5vw,3.75rem)]">
                  {t.ctaH2Start}{" "}
                  <span className="font-emphasis font-normal">{t.ctaH2Accent}</span>
                </h2>
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                  ...
                  <a href={localeHref(lang, "/realisations")} className="inline-flex items-center gap-2 rounded-full bg-white/15 hover:bg-white/25 backdrop-blur-sm text-white px-6 py-4 text-[15px] font-medium transition-colors">
                    {t.ctaSecondary}
                  </a>
                </div>
              </div>
