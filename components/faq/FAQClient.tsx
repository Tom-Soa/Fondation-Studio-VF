...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Que comprend la maintenance mensuelle ?", a: "À 150 €/mois : modifications de textes, ajout de photos, changements de pages, petites évolutions. Chaque forfait inclut déjà 1 mois offert (6 mois pour le Premium)." },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Est-ce que vous écrivez les textes ?", a: "Oui. L'optimisation du texte est incluse dans les offres Conversion et Premium. Pour le Standard, c'est une option à 300 €. Nos textes sont écrits pour vendre : ils parlent à vos clients et les poussent à agir." },
  ...
  },
  {
    ...
    questions: [
      { q: "Que se passe-t-il après la mise en ligne ?", a: "Vous bénéficiez d'une maintenance offerte (1 mois en Standard/Conversion, 6 mois en Premium). Passé ce délai, maintenance mensuelle à 150 € ou autonomie totale, c'est vous qui choisissez." },
  ...
  },
  {
    ...
    label: "E-commerce",
    questions: [
      { q: "Faites-vous des boutiques en ligne ?", a: "Oui. On crée des boutiques Shopify complètes : catalogue, panier, paiement sécurisé, gestion des commandes. Tarif sur devis selon votre catalogue. 1 mois de publicité Facebook & Instagram ou Google offert." },
