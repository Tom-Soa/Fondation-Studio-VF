...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    questions: [
      { q: "Quels sont vos tarifs ?", a: "Nos forfaits démarrent à 1 400 € (Standard, jusqu'à 5 pages), 1 900 € (Conversion, jusqu'à 8 pages avec texte optimisé), et 2 400 € et plus (Premium, sur devis). Les boutiques e-commerce Shopify démarrent à 3 900 €, avec 1 mois de publicité Facebook & Instagram ou Google offert." },
