...
> = {
  fr: {
    ...
    h2Em: "remboursent.",
    subtitle: "Tout inclus. Hébergement gratuit. Paiement en plusieurs fois. Votre site vous appartient.",
  ...
  en: {
    ...
    h2Em: "themselves.",
    subtitle: "Everything included. Free hosting. Installment payments. Your website belongs to you.",
    ecomTitle: "We also build online stores",
    ecomBadge: "Shopify e-commerce",
    ecomPrice: "Custom quote",
    ecomBody:
